...
function getCourses() {
    ...
    fetch("http://localhost/testprojekt/api/read.php")
...
function addCourse() {
    ...
    fetch("http://localhost/testprojekt/api/create.php", {
            method: "POST",
...
function deleteCourse(id) {
    fetch("http://localhost/testprojekt/api/delete.php?id=" + id, {
            method: "DELETE",
        })
        .then(response => response.json())
        .then(data => {
...
function getOneToUpdate(id) {
    ...
    fetch('http://localhost/testprojekt/api/read_one.php?id=' + id)
        .then(response => response.json())
...
function updateCourse(id) {
    ...
    fetch('http://localhost/testprojekt/api/update.php?id=' + id, {
            method: 'PUT',
            body: JSON.stringify(courses)
        })
        .then(response => response.json())
