...
function getWorkNoButton() {
    ...
    fetch("http://localhost/testprojekt/api_work/read.php")
...
function addWork() {
    ...
    fetch("http://localhost/testprojekt/api_work/create.php", {
            method: "POST",
...
function deleteWork(work_id) {
    fetch("http://localhost/testprojekt/api_work/delete.php?work_id=" + work_id, {
            method: "DELETE",
        })
        .then(response => response.json())
        .then(work_data => {
...
function getOneWorkToUpdate(work_id) {
    ...
    fetch('http://localhost/testprojekt/api_work/read_one.php?work_id=' + work_id)
        .then(response => response.json())
...
function updateWork(work_id) {
    ...
    fetch('http://localhost/testprojekt/api_work/update.php?work_id=' + work_id, {
            method: 'PUT',
            body: JSON.stringify(work)
        })
        .then(response => response.json())
