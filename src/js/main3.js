...
function getWebpagesNoButton() {
    ...
    fetch("http://localhost/testprojekt/api_webpages/read.php")
...
function addWebpages() {
    ...
    fetch("http://localhost/testprojekt/api_webpages/create.php", {
            method: "POST",
...
function deleteWebpages(web_id) {
    fetch("http://localhost/testprojekt/api_webpages/delete.php?web_id=" + web_id, {
            method: "DELETE",
        })
        .then(response => response.json())
        .then(data => {
...
function getOneWebpageToUpdate(web_id) {
    ...
    fetch("http://localhost/testprojekt/api_webpages/read_one.php?web_id=" + web_id)
        .then(response => response.json())
...
function updateWebpages(web_id) {
    ...
    fetch("http://localhost/testprojekt/api_webpages/update.php?web_id=" + web_id, {
            method: 'PUT',
            body: JSON.stringify(webpages)
        })
        .then(response => response.json())
